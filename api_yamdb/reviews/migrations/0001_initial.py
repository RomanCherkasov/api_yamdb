# Generated by Django 2.2.16 on 2021-08-12 21:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=256)),
                ('slug', models.SlugField(unique=True)),
                ('titles', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='genres', to='reviews.Title')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
